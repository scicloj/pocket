...
(deftest
 t7_l70
 (is
  ((fn* [p1__64966#] (re-find #"requires a var" p1__64966#)) v6_l65)))
...
(deftest
 t66_l237
 (is ((fn* [p1__64967#] (re-find #":pending" p1__64967#)) v65_l235)))
...
(deftest
 t70_l244
 (is ((fn* [p1__64968#] (re-find #":cached" p1__64968#)) v69_l242)))
