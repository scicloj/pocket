...
(deftest
 t7_l43
 (is
  ((fn* [p1__75375#] (re-find #"requires a var" p1__75375#)) v6_l38)))
...
(deftest
 t66_l210
 (is ((fn* [p1__75376#] (re-find #":pending" p1__75376#)) v65_l208)))
...
(deftest
 t70_l217
 (is ((fn* [p1__75377#] (re-find #":cached" p1__75377#)) v69_l215)))
