...
(deftest
 t7_l74
 (is
  ((fn* [p1__74573#] (re-find #"requires a var" p1__74573#)) v6_l69)))
...
(deftest
 t66_l241
 (is ((fn* [p1__74574#] (re-find #":pending" p1__74574#)) v65_l239)))
...
(deftest
 t70_l248
 (is ((fn* [p1__74575#] (re-find #":cached" p1__74575#)) v69_l246)))
