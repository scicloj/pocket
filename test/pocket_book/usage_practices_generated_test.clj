...
(deftest
 t6_l40
 (is
  ((fn* [p1__36896#] (re-find #"requires a var" p1__36896#)) v5_l35)))
...
(deftest
 t54_l179
 (is ((fn* [p1__36897#] (re-find #":pending" p1__36897#)) v52_l177)))
...
(deftest
 t58_l185
 (is ((fn* [p1__36898#] (re-find #":cached" p1__36898#)) v56_l183)))
