...
(deftest
 t7_l80
 (is
  ((fn* [p1__99684#] (re-find #"requires a var or keyword" p1__99684#))
   v6_l75)))
...
(deftest
 t66_l247
 (is ((fn* [p1__99685#] (re-find #":pending" p1__99685#)) v65_l245)))
...
(deftest
 t70_l254
 (is ((fn* [p1__99686#] (re-find #":cached" p1__99686#)) v69_l252)))
