...
(deftest
 t7_l80
 (is
  ((fn* [p1__20618#] (re-find #"requires a var or keyword" p1__20618#))
   v6_l75)))
...
(deftest
 t66_l247
 (is ((fn* [p1__20619#] (re-find #":pending" p1__20619#)) v65_l245)))
...
(deftest
 t70_l254
 (is ((fn* [p1__20620#] (re-find #":cached" p1__20620#)) v69_l252)))
