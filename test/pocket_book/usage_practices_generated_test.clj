...
(deftest
 t7_l80
 (is
  ((fn* [p1__70518#] (re-find #"requires a var or keyword" p1__70518#))
   v6_l75)))
...
(deftest
 t66_l247
 (is ((fn* [p1__70519#] (re-find #":pending" p1__70519#)) v65_l245)))
...
(deftest
 t70_l254
 (is ((fn* [p1__70520#] (re-find #":cached" p1__70520#)) v69_l252)))
