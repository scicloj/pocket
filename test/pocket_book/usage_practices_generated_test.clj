...
(deftest
 t7_l43
 (is
  ((fn* [p1__29085#] (re-find #"requires a var" p1__29085#)) v6_l38)))
...
(deftest
 t66_l210
 (is ((fn* [p1__29086#] (re-find #":pending" p1__29086#)) v65_l208)))
...
(deftest
 t70_l217
 (is ((fn* [p1__29087#] (re-find #":cached" p1__29087#)) v69_l215)))
