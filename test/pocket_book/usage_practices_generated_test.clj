...
(deftest
 t7_l80
 (is
  ((fn* [p1__72465#] (re-find #"requires a var or keyword" p1__72465#))
   v6_l75)))
...
(deftest
 t66_l247
 (is ((fn* [p1__72466#] (re-find #":pending" p1__72466#)) v65_l245)))
...
(deftest
 t70_l254
 (is ((fn* [p1__72467#] (re-find #":cached" p1__72467#)) v69_l252)))
