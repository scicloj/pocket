...
(deftest
 t7_l43
 (is
  ((fn* [p1__38970#] (re-find #"requires a var" p1__38970#)) v6_l38)))
...
(deftest
 t66_l209
 (is ((fn* [p1__38971#] (re-find #":pending" p1__38971#)) v64_l207)))
...
(deftest
 t70_l215
 (is ((fn* [p1__38972#] (re-find #":cached" p1__38972#)) v68_l213)))
