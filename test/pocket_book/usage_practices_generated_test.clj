...
(deftest
 t7_l80
 (is
  ((fn* [p1__70254#] (re-find #"requires a var or keyword" p1__70254#))
   v6_l75)))
...
(deftest
 t66_l247
 (is ((fn* [p1__70255#] (re-find #":pending" p1__70255#)) v65_l245)))
...
(deftest
 t70_l254
 (is ((fn* [p1__70256#] (re-find #":cached" p1__70256#)) v69_l252)))
