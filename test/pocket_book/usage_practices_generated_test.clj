...
(deftest
 t7_l43
 (is
  ((fn* [p1__45646#] (re-find #"requires a var" p1__45646#)) v6_l38)))
...
(deftest
 t66_l210
 (is ((fn* [p1__45647#] (re-find #":pending" p1__45647#)) v65_l208)))
...
(deftest
 t70_l217
 (is ((fn* [p1__45648#] (re-find #":cached" p1__45648#)) v69_l215)))
...
(def v83_l289 (pocket/cleanup!))


(def v84_l291 (defn generate-data [n] (doall (range n))))


(def v85_l295 (deref (pocket/cached #'generate-data 5)))


(deftest t86_l297 (is (= v85_l295 [0 1 2 3 4])))


(def v88_l330 (pocket/cleanup!))
