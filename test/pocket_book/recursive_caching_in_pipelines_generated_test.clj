...
(def
 ...
 (defn
  ...
  (update
   data
   :data
   (fn* [p1__19900#] (map (fn [x] (* x (:scale opts))) p1__19900#)))))
...
(def v31_l148 (deref model-c))


(def v33_l152 (pocket/origin-story model-c))


(def v35_l157 (kind/mermaid (pocket/origin-story-mermaid model-c)))


(def v37_l161 (pocket/cleanup!))
