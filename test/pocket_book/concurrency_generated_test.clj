...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29176#] (= 42 p1__29176#)) results)
     (> computation-count 1)))
   v3_l72)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__29177#] (= 100 p1__29177#)) results)
     (= 1 computation-count)))
   v18_l221)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__29178#]
     (future @(pocket/cached #'slow-computation p1__29178#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__29179#] (= 2500 p1__29179#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__29180#] (= 4900 p1__29180#)) results)
     (= 1 computation-count)))
   v52_l521)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29181#] (= 71 p1__29181#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l569)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29182#] (= 8100 p1__29182#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l681)))
