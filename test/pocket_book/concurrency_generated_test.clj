...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29491#] (= 42 p1__29491#)) results)
     (> computation-count 1)))
   v3_l65)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__29492#] (= 100 p1__29492#)) results)
     (= 1 computation-count)))
   v18_l214)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__29493#]
     (future @(pocket/cached #'slow-computation p1__29493#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__29494#] (= 2500 p1__29494#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__29495#] (= 4900 p1__29495#)) results)
     (= 1 computation-count)))
   v52_l514)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29496#] (= 71 p1__29496#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l562)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29497#] (= 8100 p1__29497#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l674)))
