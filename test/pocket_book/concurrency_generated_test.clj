...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__20837#] (= 42 p1__20837#)) results)
     (> computation-count 1)))
   v3_l72)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__20838#] (= 100 p1__20838#)) results)
     (= 1 computation-count)))
   v18_l221)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__20839#]
     (future @(pocket/cached #'slow-computation p1__20839#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__20840#] (= 2500 p1__20840#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__20841#] (= 4900 p1__20841#)) results)
     (= 1 computation-count)))
   v52_l521)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__20842#] (= 71 p1__20842#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l569)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__20843#] (= 8100 p1__20843#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l681)))
