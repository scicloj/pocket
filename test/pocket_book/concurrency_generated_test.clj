...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__69389#] (= 42 p1__69389#)) results)
     (> computation-count 1)))
   v3_l70)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__69390#] (= 100 p1__69390#)) results)
     (= 1 computation-count)))
   v18_l219)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__69391#]
     (future @(pocket/cached #'slow-computation p1__69391#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__69392#] (= 2500 p1__69392#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__69393#] (= 4900 p1__69393#)) results)
     (= 1 computation-count)))
   v52_l519)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__69394#] (= 71 p1__69394#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l567)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__69395#] (= 8100 p1__69395#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l679)))
