...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29301#] (= 42 p1__29301#)) results)
     (> computation-count 1)))
   v3_l65)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__29302#] (= 100 p1__29302#)) results)
     (= 1 computation-count)))
   v18_l214)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__29303#]
     (future @(pocket/cached #'slow-computation p1__29303#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__29304#] (= 2500 p1__29304#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__29305#] (= 4900 p1__29305#)) results)
     (= 1 computation-count)))
   v52_l514)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29306#] (= 71 p1__29306#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l562)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__29307#] (= 8100 p1__29307#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l674)))
