...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__75250#] (= 42 p1__75250#)) results)
     (> computation-count 1)))
   v3_l70)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__75251#] (= 100 p1__75251#)) results)
     (= 1 computation-count)))
   v18_l219)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__75252#]
     (future @(pocket/cached #'slow-computation p1__75252#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__75253#] (= 2500 p1__75253#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__75254#] (= 4900 p1__75254#)) results)
     (= 1 computation-count)))
   v52_l519)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__75255#] (= 71 p1__75255#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l567)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__75256#] (= 8100 p1__75256#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l679)))
