...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__70737#] (= 42 p1__70737#)) results)
     (> computation-count 1)))
   v3_l72)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__70738#] (= 100 p1__70738#)) results)
     (= 1 computation-count)))
   v18_l221)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__70739#]
     (future @(pocket/cached #'slow-computation p1__70739#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__70740#] (= 2500 p1__70740#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__70741#] (= 4900 p1__70741#)) results)
     (= 1 computation-count)))
   v52_l521)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__70742#] (= 71 p1__70742#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l569)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__70743#] (= 8100 p1__70743#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l681)))
