...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__28332#] (= 42 p1__28332#)) results)
     (> computation-count 1)))
   v3_l65)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__28333#] (= 100 p1__28333#)) results)
     (= 1 computation-count)))
   v18_l214)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__28334#]
     (future @(pocket/cached #'slow-computation p1__28334#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__28335#] (= 2500 p1__28335#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__28336#] (= 4900 p1__28336#)) results)
     (= 1 computation-count)))
   v52_l514)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__28337#] (= 71 p1__28337#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l562)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__28338#] (= 8100 p1__28338#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l674)))
