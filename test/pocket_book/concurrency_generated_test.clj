...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__105440#] (= 42 p1__105440#)) results)
     (> computation-count 1)))
   v3_l70)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 5 (count results))
     (every? (fn* [p1__105441#] (= 100 p1__105441#)) results)
     (= 1 computation-count)))
   v18_l219)))
 ...
 (let
  [start
   ...
   (mapv
    (fn*
     [p1__105442#]
     (future @(pocket/cached #'slow-computation p1__105442#)))
    [40 41 42])
   results
   (mapv deref futures)
   elapsed
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count results))
     (every? (fn* [p1__105443#] (= 2500 p1__105443#)) results)
...
(deftest
 ...
 (is
  ((fn
    [{:keys [results computation-count]}]
    (and
     (every? (fn* [p1__105444#] (= 4900 p1__105444#)) results)
     (= 1 computation-count)))
   v52_l519)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__105445#] (= 71 p1__105445#)) results)
     (= 1 step-a-count)
     (= 1 step-b-count)))
   v61_l567)))
...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (every? (fn* [p1__105446#] (= 8100 p1__105446#)) results)
     (= 1 count-after-first)
     (= 2 count-after-retry)))
   v78_l679)))
