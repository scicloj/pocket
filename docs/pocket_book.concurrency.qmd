...
```clojure
{:started-at
 #object[java.time.LocalTime 0x605736a6 "01:46:32.483425179"],
...
```clojure
{:started-at
 #object[java.time.LocalTime 0xce1bd72 "01:46:32.800364312"],
 :mem-cache {:policy :lru, :threshold 3}}
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x570d89cb "01:46:33.106483062"],
 :mem-cache {:policy :lru, :threshold 3}}
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x27559547 "01:46:34.320200143"],
 :mem-cache {:policy :lru, :threshold 3}}
...
## OUT
```
[clojure-agent-send-off-pool-25] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.concurrency/slow-computation
[clojure-agent-send-off-pool-26] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.concurrency/slow-computation
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x42a8c1f0 "01:46:34.626494200"],
 :mem-cache {:policy :lru, :threshold 3}}
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x767c464 "01:46:34.934599292"],
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x7bb9c7f "01:46:36.147648523"],
 :mem-cache {:policy :lru, :threshold 3}}
...
## OUT
```
[clojure-agent-send-off-pool-25] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.concurrency/pipeline-step-b
[clojure-agent-send-off-pool-25] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.concurrency/pipeline-step-a
...
## OUT
```
[clojure-agent-send-off-pool-25] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.concurrency/fail-once-computation
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x213a6d65 "01:46:37.187233155"],
 :mem-cache {:policy :lru, :threshold 2}}
...
```clojure
{:started-at
 #object[java.time.LocalTime 0x3996bc36 "01:46:37.500775735"],
 :mem-cache {:policy :lru, :threshold 3}}
