...
## OUT
```
15:38:49.776 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
15:38:49.776 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
15:38:49.786 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
15:38:49.988 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/a8/(pocket-book.extending-pocket⁄analyze-dataset census-v3 {:method :regression})
...
## OUT
```
15:38:49.996 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
15:38:50.197 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/6f/(pocket-book.extending-pocket⁄analyze-dataset census-v4 {:method :regression})
...
.cache
├── 6f
│   └── (pocket-book.extending-pocket⁄analyze-dataset census-v4 {:method :regression})
│       ├── meta.edn
│       └── value.nippy
└── a8
    └── (pocket-book.extending-pocket⁄analyze-dataset census-v3 {:method :regression})
        ├── meta.edn
        └── value.nippy
...
## OUT
```
15:38:50.201 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
