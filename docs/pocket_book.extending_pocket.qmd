...
## OUT
```
22:14:31.436 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
22:14:31.437 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
22:14:31.462 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
22:14:31.664 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/62/(pocket-book.extending-pocket_analyze-dataset census-v3 {:method :regression})
...
## OUT
```
22:14:31.671 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
22:14:31.872 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/f6/(pocket-book.extending-pocket_analyze-dataset census-v4 {:method :regression})
...
## OUT
```
22:14:31.895 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/train-my-model
22:14:31.896 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/ac/(pocket-book.extending-pocket_train-my-model [10 20 30])
...
## OUT
```
22:14:31.899 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
