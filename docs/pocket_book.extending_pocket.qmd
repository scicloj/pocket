...
## OUT
```
15:54:59.546 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
15:54:59.547 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
15:54:59.556 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
15:54:59.758 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/a8/(pocket-book.extending-pocket⁄analyze-dataset census-v3 {:method :regression})
...
## OUT
```
15:54:59.765 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
15:54:59.965 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/6f/(pocket-book.extending-pocket⁄analyze-dataset census-v4 {:method :regression})
...
## OUT
```
15:54:59.968 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
