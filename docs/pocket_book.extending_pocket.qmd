...
## OUT
```
16:50:50.401 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
16:50:50.401 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
16:50:50.411 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
16:50:50.613 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/a8/(pocket-book.extending-pocket⁄analyze-dataset census-v3 {:method :regression})
...
## OUT
```
16:50:50.617 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
16:50:50.817 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/6f/(pocket-book.extending-pocket⁄analyze-dataset census-v4 {:method :regression})
...
## OUT
```
16:50:50.821 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
