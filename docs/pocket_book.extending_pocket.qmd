...
## OUT
```
19:24:44.051 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
19:24:44.052 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
19:24:44.075 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
...
## OUT
```
19:24:44.284 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
...
::: {.printedClojure}
```clojure
{459 #function[tech.v3.datatype.nippy/eval32828/fn--32829/fn--32830],
 -26414
 #function[tech.v3.datatype.nippy/eval32864/fn--32865/fn--32866],
 -26665
 #function[tech.v3.dataset.io.nippy/eval32882/fn--32883/fn--32884],
 -7792
 #function[tech.v3.dataset.io.nippy/eval32896/fn--32897/fn--32898],
 16600
 #function[pocket-book.extending-pocket/eval102969/fn--102970/fn--102971]}
...
## OUT
```
19:24:44.514 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/train-my-model
...
## OUT
```
19:24:44.518 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
