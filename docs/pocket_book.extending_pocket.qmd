...
## OUT
```
21:44:03.887 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
21:44:03.888 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
21:44:03.909 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
21:44:04.111 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/62/(pocket-book.extending-pocket_analyze-dataset census-v3 {:method :regression})
...
## OUT
```
21:44:04.116 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
21:44:04.318 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/f6/(pocket-book.extending-pocket_analyze-dataset census-v4 {:method :regression})
...
## OUT
```
21:44:04.346 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/train-my-model
21:44:04.347 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/ac/(pocket-book.extending-pocket_train-my-model [10 20 30])
...
## OUT
```
21:44:04.350 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
