...
## OUT
```
13:27:53.329 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
13:27:53.330 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
13:27:53.367 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
13:27:53.569 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/62/(pocket-book.extending-pocket_analyze-dataset census-v3 {:method :regression})
...
## OUT
```
13:27:53.574 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
13:27:53.776 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/f6/(pocket-book.extending-pocket_analyze-dataset census-v4 {:method :regression})
...
## OUT
```
13:27:53.779 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
