...
## OUT
```
14:17:16.096 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
14:17:16.097 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
14:17:16.118 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
14:17:16.321 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/a8/(pocket-book.extending-pocket⁄analyze-dataset census-v3 {:method :regression})
...
## OUT
```
14:17:16.326 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
14:17:16.527 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/6f/(pocket-book.extending-pocket⁄analyze-dataset census-v4 {:method :regression})
...
## OUT
```
14:17:16.532 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
