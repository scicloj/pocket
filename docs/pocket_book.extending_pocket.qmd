...
## OUT
```
18:40:57.094 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-extending
...
## OUT
```
18:40:57.094 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
...
## OUT
```
18:40:57.104 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 3 ...
18:40:57.305 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/a8/(pocket-book.extending-pocket⁄analyze-dataset census-v3 {:method :regression})
...
## OUT
```
18:40:57.309 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.extending-pocket/analyze-dataset
  Analyzing census v 4 ...
18:40:57.511 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-extending/.cache/6f/(pocket-book.extending-pocket⁄analyze-dataset census-v4 {:method :regression})
...
## OUT
```
18:40:57.515 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-extending
