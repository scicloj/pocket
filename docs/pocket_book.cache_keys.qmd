...
```clojure
{:rows 50000,
 :string-length 1541509,
 :->id-ms 4.779956,
 :canonical-id-ms 7.224922,
 :str-ms 16.042216,
 :sha-ms 0.85334}
...
## OUT
```
[nREPL-session-82f19dfb-7051-41ff-8d31-fe9c05319135] INFO scicloj.pocket - Cache dir set to: /tmp/pocket-cache-keys
...
## OUT
```
[nREPL-session-82f19dfb-7051-41ff-8d31-fe9c05319135] INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
...
## OUT
```
[nREPL-session-82f19dfb-7051-41ff-8d31-fe9c05319135] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.cache-keys/make-data
...
::: {.printedClojure}
```clojure
{:derefed-with-origin-ms 0.020882}
