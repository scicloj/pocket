...
```clojure
{:rows 50000,
 :string-length 1541270,
 :->id-ms 2.461174,
 :canonical-id-ms 6.700839,
 :str-ms 22.311826,
 :sha-ms 1.45779}
...
## OUT
```
19:24:45.713 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-cache-keys
...
## OUT
```
19:24:45.714 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
...
## OUT
```
19:24:45.744 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
