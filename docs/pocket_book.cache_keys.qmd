...
```clojure
{:rows 50000,
 :string-length 1541486,
 :->id-ms 2.49089,
 :canonical-id-ms 6.64036,
 :str-ms 22.935016,
 :sha-ms 1.483822}
...
## OUT
```
21:50:32.449 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-cache-keys
...
## OUT
```
21:50:32.451 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
...
## OUT
```
21:50:32.480 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
