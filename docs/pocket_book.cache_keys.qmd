...
```clojure
{:rows 50000,
 :string-length 1541278,
 :->id-ms 2.847531,
 :canonical-id-ms 8.059703,
 :str-ms 22.274872,
 :sha-ms 1.444101}
...
## OUT
```
22:14:33.481 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-cache-keys
...
## OUT
```
22:14:33.482 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
...
## OUT
```
22:14:33.513 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
