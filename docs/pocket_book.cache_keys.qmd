...
```clojure
{:rows 50000,
 :string-length 1541421,
 :->id-ms 20.270076,
 :canonical-id-ms 6.13049,
 :str-ms 26.581939,
 :sha-ms 2.011026}
...
## OUT
```
[nREPL-session-da935d57-d44a-48ad-9272-3a3413aeb98c] INFO scicloj.pocket - Cache dir set to: /tmp/pocket-cache-keys
...
## OUT
```
[nREPL-session-da935d57-d44a-48ad-9272-3a3413aeb98c] INFO scicloj.pocket - Cache cleanup: /tmp/pocket-cache-keys
...
## OUT
```
[nREPL-session-da935d57-d44a-48ad-9272-3a3413aeb98c] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.cache-keys/make-data
...
::: {.printedClojure}
```clojure
{:derefed-with-origin-ms 0.044514}
