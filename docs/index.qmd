...
- [🚧 Draft: `pocket-model` — drop-in caching for metamorph.ml](pocket_book.pocket_model.html)



- [🚧 Draft: `pocket-pipeline` — cached ML pipelines with `evaluate-pipelines`](pocket_book.pocket_pipeline.html)



- [Under the hood: cache keys](pocket_book.cache_keys.html)
