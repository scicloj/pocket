...
## OUT
```
16:50:39.520 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-pipelines
...
## OUT
```
16:50:39.521 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-pipelines
...
## OUT
```
16:50:39.524 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.recursive-caching-in-pipelines/train-model
16:50:39.524 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.recursive-caching-in-pipelines/preprocess
16:50:39.524 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.recursive-caching-in-pipelines/load-dataset
Loading dataset from data/raw.csv ...
16:50:39.825 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-pipelines/.cache/d3/(pocket-book.recursive-caching-in-pipelines⁄load-dataset "data⁄raw.csv")
Preprocessing with options: {:scale 2}
16:50:40.127 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-pipelines/.cache/d7/(pocket-book.recursive-caching-in-pipelines⁄preprocess (pocket-book.recursive-caching-in-pipelines⁄load-dataset "data⁄raw.csv") {:scale 2})
Training model with params: {:epochs 100}
16:50:40.428 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-pipelines/.cache/c0/(pocket-book.recursive-caching-in-pipelines⁄train-model (pocket-book.recursive-caching-in-pipelines⁄preprocess (pocket-book.recursive-caching-in-pipelines⁄load-dataset "data⁄raw.csv") {:scale 2}) {:epochs 100})
"Elapsed time: 904.705599 msecs"
...
## OUT
```
16:50:40.432 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.recursive-caching-in-pipelines/train-model
16:50:40.432 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.recursive-caching-in-pipelines/preprocess
16:50:40.432 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.recursive-caching-in-pipelines/load-dataset
Loading dataset from data/experiment.csv ...
16:50:40.734 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-pipelines/.cache/21/(pocket-book.recursive-caching-in-pipelines⁄load-dataset "data⁄experiment.csv")
Preprocessing with options: {:scale 2}
16:50:41.035 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-pipelines/.cache/dc/(pocket-book.recursive-caching-in-pipelines⁄preprocess (pocket-book.recursive-caching-in-pipelines⁄load-dataset "data⁄experiment.csv") {:scale 2})
Training model with params: {:epochs 100}
16:50:41.336 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-pipelines/.cache/ab/(pocket-book.recursive-caching-in-pipelines⁄train-model (pocket-book.recursive-caching-in-pipelines⁄preprocess (pocket-book.recursive-caching-in-pipelines⁄load-dataset "data⁄experiment.csv") {:scale 2}) {:epochs 100})
...
## OUT
```
16:50:41.340 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-pipelines
