...
## OUT
```
19:24:31.472 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
19:24:31.473 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
19:24:31.476 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
"Elapsed time: 402.43261 msecs"
...
## OUT
```
19:24:31.885 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
"Elapsed time: 401.639803 msecs"
...
## OUT
```
19:24:32.291 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
"Elapsed time: 401.665985 msecs"
...
## OUT
```
19:24:32.696 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
...
## OUT
```
19:24:32.701 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
