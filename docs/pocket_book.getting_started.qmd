...
## OUT
```
15:54:47.405 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
15:54:47.406 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
15:54:47.408 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
15:54:47.810 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/6b/(pocket-book.getting-started⁄expensive-calculation 10 20)
"Elapsed time: 401.484593 msecs"
...
## OUT
```
15:54:47.813 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
15:54:48.215 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/93/(pocket-book.getting-started⁄expensive-calculation 5 15)
"Elapsed time: 401.502992 msecs"
...
## OUT
```
15:54:48.219 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
15:54:48.620 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/d9/(pocket-book.getting-started⁄expensive-calculation 7 8)
"Elapsed time: 401.335953 msecs"
...
## OUT
```
15:54:48.623 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
15:54:48.624 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/f5/(pocket-book.getting-started⁄returns-nil)
...
## OUT
```
15:54:48.626 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
