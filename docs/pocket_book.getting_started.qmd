...
## OUT
```
21:50:17.887 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
21:50:17.888 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
21:50:17.891 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
21:50:18.293 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/fb/(pocket-book.getting-started_expensive-calculation 10 20)
"Elapsed time: 402.170627 msecs"
...
## OUT
```
21:50:18.307 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
21:50:18.719 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/c4/(pocket-book.getting-started_expensive-calculation 5 15)
"Elapsed time: 413.095429 msecs"
...
## OUT
```
21:50:18.725 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
21:50:19.126 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/a2/(pocket-book.getting-started_expensive-calculation 7 8)
"Elapsed time: 401.689263 msecs"
...
## OUT
```
21:50:19.130 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
21:50:19.130 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/7a/(pocket-book.getting-started_returns-nil)
...
## OUT
```
21:50:19.133 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
