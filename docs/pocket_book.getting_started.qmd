...
## OUT
```
21:43:51.257 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
21:43:51.258 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
21:43:51.261 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
"Elapsed time: 401.711914 msecs"
...
## OUT
```
21:43:51.667 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
"Elapsed time: 402.309306 msecs"
...
## OUT
```
21:43:52.076 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
"Elapsed time: 412.340829 msecs"
...
## OUT
```
21:43:52.492 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
...
## OUT
```
21:43:52.496 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
