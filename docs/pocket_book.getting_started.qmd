...
## OUT
```
16:50:38.249 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
16:50:38.250 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
16:50:38.252 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
16:50:38.653 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/6b/(pocket-book.getting-started⁄expensive-calculation 10 20)
"Elapsed time: 401.44077 msecs"
...
## OUT
```
16:50:38.657 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
16:50:39.058 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/93/(pocket-book.getting-started⁄expensive-calculation 5 15)
"Elapsed time: 401.21216 msecs"
...
## OUT
```
16:50:39.064 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
16:50:39.465 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/d9/(pocket-book.getting-started⁄expensive-calculation 7 8)
"Elapsed time: 401.686876 msecs"
...
## OUT
```
16:50:39.469 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
16:50:39.469 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/.cache/f5/(pocket-book.getting-started⁄returns-nil)
...
## OUT
```
16:50:39.471 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
