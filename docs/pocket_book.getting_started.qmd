...
## OUT
```
22:14:18.774 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
22:14:18.775 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
22:14:18.778 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
"Elapsed time: 401.637085 msecs"
...
## OUT
```
22:14:19.185 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
"Elapsed time: 401.493312 msecs"
...
## OUT
```
22:14:19.590 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
"Elapsed time: 401.971299 msecs"
...
## OUT
```
22:14:19.999 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
...
## OUT
```
22:14:20.010 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
