...
## OUT
```
13:27:40.454 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo
...
## OUT
```
13:27:40.455 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
...
## OUT
```
13:27:40.460 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:27:40.862 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/fb/(pocket-book.getting-started_expensive-calculation 10 20)
"Elapsed time: 402.664787 msecs"
...
## OUT
```
13:27:40.869 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 5 + 15 (this is expensive!)
13:27:41.270 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/c4/(pocket-book.getting-started_expensive-calculation 5 15)
"Elapsed time: 402.945575 msecs"
...
## OUT
```
13:27:41.275 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/expensive-calculation
Computing 7 + 8 (this is expensive!)
13:27:41.677 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/a2/(pocket-book.getting-started_expensive-calculation 7 8)
"Elapsed time: 402.129089 msecs"
...
## OUT
```
13:27:41.681 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.getting-started/returns-nil
13:27:41.682 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo/7a/(pocket-book.getting-started_returns-nil)
...
## OUT
```
13:27:41.687 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo
