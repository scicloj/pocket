...
## OUT
```
15:38:57.777 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
15:38:57.777 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
15:38:57.778 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-2
...
## OUT
```
15:38:57.779 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
15:38:57.781 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 100 + 200 (this is expensive!)
15:38:58.182 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/27/(pocket-book.api-reference⁄expensive-calculation 100 200)
...
## OUT
```
15:38:58.186 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
15:38:58.587 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)
...
## OUT
```
15:38:58.594 INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
15:38:58.594 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
15:38:58.595 INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
15:38:58.595 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
15:38:58.595 INFO scicloj.pocket - Mem-cache options reset to defaults: {:policy :lru, :threshold 256}
15:38:58.595 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
15:38:58.596 INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
15:38:58.596 INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
15:38:58.597 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
15:38:58.598 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
15:38:59.000 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
15:38:59.002 DEBUG scicloj.pocket.impl.cache - Cache hit (disk): pocket-book.api-reference/expensive-calculation /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
15:38:59.003 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20) existed= true
...
## OUT
```
15:38:59.003 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
15:38:59.404 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
15:38:59.406 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 1 + 2 (this is expensive!)
15:38:59.808 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/fc/(pocket-book.api-reference⁄expensive-calculation 1 2)
...
## OUT
```
15:38:59.809 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
15:39:00.210 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)
...
## OUT
```
15:39:00.213 INFO scicloj.pocket.impl.cache - Invalidated 3 entries for pocket-book.api-reference/expensive-calculation
...
## OUT
```
15:39:00.213 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
15:39:00.215 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
15:39:00.616 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
15:39:00.617 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
15:39:01.018 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)
...
[{:path
  ...
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[10 20]",
  :created-at "2026-02-06T13:39:00.615212988Z"}
 {:path
  "/tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)",
  :id "(pocket-book.api-reference/expensive-calculation 3 4)",
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[3 4]",
  :created-at "2026-02-06T13:39:01.018112369Z"}]
...
## OUT
```
15:39:01.024 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
15:39:01.026 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-b
15:39:01.026 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-a
15:39:01.026 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/85/(pocket-book.api-reference⁄step-a 5)
15:39:01.027 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/e0/(pocket-book.api-reference⁄step-b (pocket-book.api-reference⁄step-a 5) 3)
...
## OUT
```
15:39:01.029 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
15:39:01.030 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/aa/(pocket-book.api-reference⁄run-exp {:epochs 100, :lr 0.01})
15:39:01.030 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
15:39:01.030 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/6e/(pocket-book.api-reference⁄run-exp {:epochs 100, :lr 0.001})
...
## OUT
```
15:39:01.031 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
