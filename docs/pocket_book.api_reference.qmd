...
## OUT
```
18:41:05.131 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
18:41:05.131 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
18:41:05.132 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-2
...
## OUT
```
18:41:05.133 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
18:41:05.134 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 100 + 200 (this is expensive!)
18:41:05.536 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/27/(pocket-book.api-reference⁄expensive-calculation 100 200)
...
## OUT
```
18:41:05.540 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
18:41:05.941 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)
...
## OUT
```
18:41:05.947 INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
18:41:05.947 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
18:41:05.947 INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
18:41:05.948 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
18:41:05.948 INFO scicloj.pocket - Mem-cache options reset to defaults: {:policy :lru, :threshold 256}
18:41:05.948 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
18:41:05.949 INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
18:41:05.949 INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
18:41:05.950 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
18:41:05.951 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
18:41:06.352 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
18:41:06.354 DEBUG scicloj.pocket.impl.cache - Cache hit (disk): pocket-book.api-reference/expensive-calculation /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
18:41:06.355 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20) existed= true
...
## OUT
```
18:41:06.356 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
18:41:06.757 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
18:41:06.759 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 1 + 2 (this is expensive!)
18:41:07.160 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/fc/(pocket-book.api-reference⁄expensive-calculation 1 2)
...
## OUT
```
18:41:07.161 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
18:41:07.562 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)
...
## OUT
```
18:41:07.565 INFO scicloj.pocket.impl.cache - Invalidated 3 entries for pocket-book.api-reference/expensive-calculation
...
## OUT
```
18:41:07.566 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
18:41:07.567 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
18:41:07.968 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/45/(pocket-book.api-reference⁄expensive-calculation 10 20)
...
## OUT
```
18:41:07.969 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
18:41:08.370 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)
...
[{:path
  ...
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[10 20]",
  :created-at "2026-02-06T16:41:07.967325199Z"}
 {:path
  "/tmp/pocket-demo-reference/.cache/53/(pocket-book.api-reference⁄expensive-calculation 3 4)",
  :id "(pocket-book.api-reference/expensive-calculation 3 4)",
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[3 4]",
  :created-at "2026-02-06T16:41:08.369881674Z"}]
...
## OUT
```
18:41:08.377 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
18:41:08.379 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-b
18:41:08.379 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-a
18:41:08.379 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/85/(pocket-book.api-reference⁄step-a 5)
18:41:08.379 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/e0/(pocket-book.api-reference⁄step-b (pocket-book.api-reference⁄step-a 5) 3)
...
## OUT
```
18:41:08.382 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
18:41:08.382 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/aa/(pocket-book.api-reference⁄run-exp {:epochs 100, :lr 0.01})
18:41:08.382 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
18:41:08.382 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/.cache/6e/(pocket-book.api-reference⁄run-exp {:epochs 100, :lr 0.001})
...
## OUT
```
18:41:08.384 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
