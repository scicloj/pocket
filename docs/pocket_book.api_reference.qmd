...
## OUT
```
21:44:05.438 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
21:44:05.439 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
21:44:05.441 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-2
...
## OUT
```
21:44:05.442 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
21:44:05.445 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 100 + 200 (this is expensive!)
21:44:05.846 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/89/(pocket-book.api-reference_expensive-calculation 100 200)
...
## OUT
```
21:44:05.852 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
21:44:06.254 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
## OUT
```
21:44:06.267 INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
21:44:06.267 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
21:44:06.268 INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
21:44:06.268 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
21:44:06.270 INFO scicloj.pocket - Mem-cache options reset to defaults: {:policy :lru, :threshold 256}
21:44:06.270 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
21:44:06.272 INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
21:44:06.272 INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
21:44:06.276 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
21:44:06.278 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
21:44:06.680 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
21:44:06.685 DEBUG scicloj.pocket.impl.cache - Cache hit (disk): pocket-book.api-reference/expensive-calculation /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
21:44:06.687 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20) existed= true
...
## OUT
```
21:44:06.688 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
21:44:07.090 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
21:44:07.092 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 1 + 2 (this is expensive!)
21:44:07.494 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/d2/(pocket-book.api-reference_expensive-calculation 1 2)
...
## OUT
```
21:44:07.495 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
21:44:07.896 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
## OUT
```
21:44:07.900 INFO scicloj.pocket.impl.cache - Invalidated 3 entries for pocket-book.api-reference/expensive-calculation
...
## OUT
```
21:44:07.902 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
21:44:07.904 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
21:44:08.305 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
21:44:08.308 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
21:44:08.720 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
[{:path
  ...
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[10 20]",
  :created-at "2026-02-08T19:44:08.304999266Z"}
 {:path
  "/tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)",
  :id "(pocket-book.api-reference/expensive-calculation 3 4)",
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[3 4]",
  :created-at "2026-02-08T19:44:08.708564961Z"}]
...
## OUT
```
21:44:08.729 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
21:44:08.734 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-b
21:44:08.734 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-a
21:44:08.734 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/6a/(pocket-book.api-reference_step-a 5)
21:44:08.735 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/1b/(pocket-book.api-reference_step-b (pocket-book.api-reference_step-a 5) 3)
...
## OUT
```
21:44:08.741 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
21:44:08.742 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/18/(pocket-book.api-reference_run-exp {:epochs 100, :lr 0.01})
21:44:08.742 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
21:44:08.742 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/13/(pocket-book.api-reference_run-exp {:epochs 100, :lr 0.001})
...
## OUT
```
21:44:08.745 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
