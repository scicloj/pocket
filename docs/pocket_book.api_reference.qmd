...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-2
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-demo-reference/.cache/84/(pocket-book.api-reference⁄expensive-calculation 10 20) existed= true
...
```clojure
{:path
 "/tmp/pocket-demo-reference/.cache/84/(pocket-book.api-reference⁄expensive-calculation 10 20)",
 :existed true}
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Invalidated 3 entries for pocket-book.api-reference/expensive-calculation
...
{:fn-name "pocket-book.api-reference/expensive-calculation",
 :count 3,
 :paths
 ["/tmp/pocket-demo-reference/.cache/0a/(pocket-book.api-reference⁄expensive-calculation 3 4)"
  "/tmp/pocket-demo-reference/.cache/84/(pocket-book.api-reference⁄expensive-calculation 10 20)"
  "/tmp/pocket-demo-reference/.cache/27/(pocket-book.api-reference⁄expensive-calculation 1 2)"]}
...
[{:path
  ...
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[3 4]",
  :created-at "2026-02-06T17:42:33.278955615Z"}
 {:path
  "/tmp/pocket-demo-reference/.cache/84/(pocket-book.api-reference⁄expensive-calculation 10 20)",
  :id "(pocket-book.api-reference/expensive-calculation 10 20)",
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[10 20]",
  :created-at "2026-02-06T17:42:32.875755076Z"}]
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-b
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-a
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
