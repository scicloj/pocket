...
## OUT
```
13:27:55.253 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
13:27:55.254 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:27:55.257 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-2
...
## OUT
```
13:27:55.258 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
13:27:55.261 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 100 + 200 (this is expensive!)
13:27:55.663 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/89/(pocket-book.api-reference_expensive-calculation 100 200)
...
## OUT
```
13:27:55.670 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
13:27:56.071 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
## OUT
```
13:27:56.088 INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
13:27:56.088 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
13:27:56.089 INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
13:27:56.089 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
13:27:56.090 INFO scicloj.pocket - Mem-cache options reset to defaults: {:policy :lru, :threshold 256}
13:27:56.090 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
13:27:56.092 INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
13:27:56.093 INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
13:27:56.097 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:27:56.098 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:27:56.500 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:27:56.503 DEBUG scicloj.pocket.impl.cache - Cache hit (disk): pocket-book.api-reference/expensive-calculation /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:27:56.505 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20) existed= true
...
## OUT
```
13:27:56.505 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:27:56.907 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:27:56.909 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 1 + 2 (this is expensive!)
13:27:57.311 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/d2/(pocket-book.api-reference_expensive-calculation 1 2)
...
## OUT
```
13:27:57.314 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
13:27:57.716 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
## OUT
```
13:27:57.721 INFO scicloj.pocket.impl.cache - Invalidated 3 entries for pocket-book.api-reference/expensive-calculation
...
## OUT
```
13:27:57.724 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:27:57.730 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:27:58.132 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:27:58.135 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
13:27:58.538 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
[{:path
  ...
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[10 20]",
  :created-at "2026-02-08T11:27:58.130793532Z"}
 {:path
  "/tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)",
  :id "(pocket-book.api-reference/expensive-calculation 3 4)",
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[3 4]",
  :created-at "2026-02-08T11:27:58.536379225Z"}]
...
## OUT
```
13:27:58.547 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:27:58.551 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-b
13:27:58.552 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-a
13:27:58.552 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/6a/(pocket-book.api-reference_step-a 5)
13:27:58.553 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/1b/(pocket-book.api-reference_step-b (pocket-book.api-reference_step-a 5) 3)
...
## OUT
```
13:27:58.560 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
13:27:58.561 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/18/(pocket-book.api-reference_run-exp {:epochs 100, :lr 0.01})
13:27:58.561 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
13:27:58.561 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/13/(pocket-book.api-reference_run-exp {:epochs 100, :lr 0.001})
...
## OUT
```
13:27:58.565 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
