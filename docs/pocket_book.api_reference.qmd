...
## OUT
```
13:37:22.143 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
13:37:22.144 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:37:22.146 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-2
...
## OUT
```
13:37:22.147 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-reference
...
## OUT
```
13:37:22.150 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 100 + 200 (this is expensive!)
13:37:22.552 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/89/(pocket-book.api-reference_expensive-calculation 100 200)
...
## OUT
```
13:37:22.559 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
13:37:22.960 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
## OUT
```
13:37:22.977 INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
13:37:22.977 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
13:37:22.978 INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
13:37:22.978 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
13:37:22.979 INFO scicloj.pocket - Mem-cache options reset to defaults: {:policy :lru, :threshold 256}
13:37:22.979 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
13:37:22.981 INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
13:37:22.981 INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
13:37:22.985 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:37:22.986 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:37:23.389 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:37:23.393 DEBUG scicloj.pocket.impl.cache - Cache hit (disk): pocket-book.api-reference/expensive-calculation /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:37:23.394 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20) existed= true
...
## OUT
```
13:37:23.395 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:37:23.796 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:37:23.800 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 1 + 2 (this is expensive!)
13:37:24.202 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/d2/(pocket-book.api-reference_expensive-calculation 1 2)
...
## OUT
```
13:37:24.204 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
13:37:24.606 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
## OUT
```
13:37:24.610 INFO scicloj.pocket.impl.cache - Invalidated 3 entries for pocket-book.api-reference/expensive-calculation
...
## OUT
```
13:37:24.611 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:37:24.612 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 10 + 20 (this is expensive!)
13:37:25.014 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/a3/(pocket-book.api-reference_expensive-calculation 10 20)
...
## OUT
```
13:37:25.016 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/expensive-calculation
Computing 3 + 4 (this is expensive!)
13:37:25.418 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)
...
[{:path
  ...
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[10 20]",
  :created-at "2026-02-08T11:37:25.012961287Z"}
 {:path
  "/tmp/pocket-demo-reference/49/(pocket-book.api-reference_expensive-calculation 3 4)",
  :id "(pocket-book.api-reference/expensive-calculation 3 4)",
  :fn-name "pocket-book.api-reference/expensive-calculation",
  :args-str "[3 4]",
  :created-at "2026-02-08T11:37:25.417260072Z"}]
...
## OUT
```
13:37:25.426 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
...
## OUT
```
13:37:25.431 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-b
13:37:25.431 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/step-a
13:37:25.432 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/6a/(pocket-book.api-reference_step-a 5)
13:37:25.433 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/1b/(pocket-book.api-reference_step-b (pocket-book.api-reference_step-a 5) 3)
...
## OUT
```
13:37:25.439 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
13:37:25.440 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/18/(pocket-book.api-reference_run-exp {:epochs 100, :lr 0.01})
13:37:25.440 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.api-reference/run-exp
13:37:25.441 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-demo-reference/13/(pocket-book.api-reference_run-exp {:epochs 100, :lr 0.001})
...
## OUT
```
13:37:25.445 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-reference
