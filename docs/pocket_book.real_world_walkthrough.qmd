...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Cache dir set to: /tmp/pocket-walkthrough
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket - Cache cleanup: /tmp/pocket-walkthrough
...
## OUT
```
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/summary
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/temperature-trends
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/clean-data
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/fetch-readings
  Fetching readings for London ...
  Cleaning data for London with {:precision 10, :remove-nulls true} ...
  Analyzing temperature for London ...
[nREPL-session-94df5099-9db7-4f41-be96-e3b17949b1df] INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/rainfall-totals
  Analyzing rainfall for London ...
  Generating summary for London ...
"Elapsed time: 1310.654258 msecs"
...
"Elapsed time: 1308.954806 msecs"
...
```clojure
[{:path
  "/tmp/pocket-walkthrough/.cache/e0/(pocket-book.real-world-walkthrough⁄fetch-readings {:city \"Paris\", :days 7, :source :api})",
  :id
  ...
  :created-at "2026-02-06T17:42:14.723919826Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/c5/c525d35cd8db735967050d94c90504d4fff4fd88",
  :id
  ...
  :created-at "2026-02-06T17:42:13.912414934Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/b9/(pocket-book.real-world-walkthrough⁄clean-data (pocket-book.real-world-walkthrough⁄fetch-readings {:city \"Paris\", :days 7, :source :api}) {:precision 10, :remove-nulls true})",
  :id
  ...
  :created-at "2026-02-06T17:42:14.925599128Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/3b/3b52543eb01fa985687706e01cefef95d49377c0",
  :id
  ...
  :created-at "2026-02-06T17:42:15.227243799Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/36/36d7883057896a6ed9a01638cf44c1b5e7b043ce",
  :id
  ...
  :created-at "2026-02-06T17:42:14.416671013Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/ac/(pocket-book.real-world-walkthrough⁄fetch-readings {:city \"London\", :days 7, :source :api})",
  :id
  "(pocket-book.real-world-walkthrough/fetch-readings {:city \"London\", :days 7, :source :api})",
  :fn-name "pocket-book.real-world-walkthrough/fetch-readings",
  :args-str "[{:city \"London\", :days 7, :source :api}]",
  :created-at "2026-02-06T17:42:13.408504411Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/a5/(pocket-book.real-world-walkthrough⁄clean-data (pocket-book.real-world-walkthrough⁄fetch-readings {:city \"London\", :days 7, :source :api}) {:precision 10, :remove-nulls true})",
  :id
  ...
  :created-at "2026-02-06T17:42:13.610759137Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/6a/6ad34b3726540ad8be7ea6846ceabfef80622947",
  :id
  ...
  :args-str
  "[(pocket-book.real-world-walkthrough/temperature-trends (pocket-book.real-world-walkthrough/clean-data (pocket-book.real-world-walkthrough/fetch-readings {:city \"Paris\", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :celsius}) (pocket-book.real-world-walkthrough/rainfall-totals (pocket-book.real-world-walkthrough/clean-data (pocket-book.real-world-walkthrough/fetch-readings {:city \"Paris\", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :mm})]",
  :created-at "2026-02-06T17:42:15.730926681Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/9b/(pocket-book.real-world-walkthrough⁄rainfall-totals (pocket-book.real-world-walkthrough⁄clean-data (pocket-book.real-world-walkthrough⁄fetch-readings {:city \"London\", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :mm})",
  :id
  ...
  :created-at "2026-02-06T17:42:14.214507125Z"}
 {:path
  "/tmp/pocket-walkthrough/.cache/78/(pocket-book.real-world-walkthrough⁄rainfall-totals (pocket-book.real-world-walkthrough⁄clean-data (pocket-book.real-world-walkthrough⁄fetch-readings {:city \"Paris\", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :mm})",
  :id
  ...
  :created-at "2026-02-06T17:42:15.529203393Z"}]
...
.cache
├── 36
│   └── 36d7883057896a6ed9a01638cf44c1b5e7b043ce
│       ├── meta.edn
│       └── value.nippy
├── 3b
│   └── 3b52543eb01fa985687706e01cefef95d49377c0
│       ├── meta.edn
│       └── value.nippy
├── 6a
│   └── 6ad34b3726540ad8be7ea6846ceabfef80622947
│       ├── meta.edn
│       └── value.nippy
├── 78
│   └── (pocket-book.real-world-walkthrough⁄rainfall-totals (pocket-book.real-world-walkthrough⁄clean-data (pocket-book.real-world-walkthrough⁄fetch-readings {:city "Paris", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :mm})
...
│       └── value.nippy
├── c5
│   └── c525d35cd8db735967050d94c90504d4fff4fd88
│       ├── meta.edn
│       └── value.nippy
└── e0
    └── (pocket-book.real-world-walkthrough⁄fetch-readings {:city "Paris", :days 7, :source :api})
