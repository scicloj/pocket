...
## OUT
```
19:24:34.823 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-walkthrough
...
## OUT
```
19:24:34.824 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-walkthrough
...
## OUT
```
19:24:34.834 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/summary
19:24:34.834 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/temperature-trends
19:24:34.835 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/clean-data
19:24:34.835 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/fetch-readings
  Fetching readings for London ...
  Cleaning data for London with {:precision 10, :remove-nulls true} ...
  Analyzing temperature for London ...
19:24:35.643 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/rainfall-totals
  Analyzing rainfall for London ...
  Generating summary for London ...
"Elapsed time: 1314.190036 msecs"
...
## OUT
```
19:24:36.159 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/summary
19:24:36.159 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/temperature-trends
19:24:36.159 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/clean-data
19:24:36.159 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/fetch-readings
  Fetching readings for Paris ...
  Cleaning data for Paris with {:precision 10, :remove-nulls true} ...
  Analyzing temperature for Paris ...
19:24:36.965 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.real-world-walkthrough/rainfall-totals
  Analyzing rainfall for Paris ...
  Generating summary for Paris ...
"Elapsed time: 1309.964393 msecs"
...
[{:path
  ...
  :created-at "2026-02-08T17:24:35.641802973Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:37.467583663Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:35.339476433Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:37.265976655Z"}
 {:path
  ...
  :args-str
  "[(pocket-book.real-world-walkthrough/temperature-trends (pocket-book.real-world-walkthrough/clean-data (pocket-book.real-world-walkthrough/fetch-readings {:city \"London\", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :celsius}) (pocket-book.real-world-walkthrough/rainfall-totals (pocket-book.real-world-walkthrough/clean-data (pocket-book.real-world-walkthrough/fetch-readings {:city \"London\", :days 7, :source :api}) {:precision 10, :remove-nulls true}) {:unit :mm})]",
  :created-at "2026-02-08T17:24:36.147608507Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:36.661539321Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:36.459796900Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:35.136017295Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:35.944338995Z"}
 {:path
  ...
  :created-at "2026-02-08T17:24:36.963860688Z"}]
...
## OUT
```
19:24:37.486 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-walkthrough
