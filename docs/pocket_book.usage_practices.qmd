...
## OUT
```
13:27:43.739 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.745 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.747 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
13:27:43.748 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/1c/(pocket-book.usage-practices_transform 10)
...
## OUT
```
13:27:43.752 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/1c/(pocket-book.usage-practices_transform 10) existed= true
...
## OUT
```
13:27:43.753 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
13:27:43.753 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/db/(pocket-book.usage-practices_transform 1)
...
## OUT
```
13:27:43.754 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
13:27:43.754 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e4/(pocket-book.usage-practices_transform 2)
...
## OUT
```
13:27:43.757 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
13:27:43.758 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.761 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
13:27:43.761 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/58/(pocket-book.usage-practices_process-data {:data [1 2 3], :version 1})
...
## OUT
```
13:27:43.763 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
13:27:43.763 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/64/(pocket-book.usage-practices_process-data {:data [1 2 3], :version 2})
...
## OUT
```
13:27:43.765 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.766 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.768 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
13:27:43.768 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/4a/(pocket-book.usage-practices_tracked-fn 5)
...
## OUT
```
13:27:43.771 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.772 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
13:27:43.772 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/db/(pocket-book.usage-practices_transform 1)
...
## OUT
```
13:27:43.773 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
13:27:43.773 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e4/(pocket-book.usage-practices_transform 2)
...
## OUT
```
13:27:43.774 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
13:27:43.774 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e8/(pocket-book.usage-practices_tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-08T11:27:43.772374504Z"}
...
[{:path
 ...
 {:path
  ...
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-08T11:27:43.773512926Z"}
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-08T11:27:43.774551130Z"}]
...
## OUT
```
13:27:43.784 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.787 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
13:27:43.787 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/d8/(pocket-book.usage-practices_transform 99)
...
## OUT
```
13:27:43.789 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.791 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
13:27:43.792 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/6d/6d7a9c06574c78354a8235a2e77b6ed27348e404
...
## OUT
```
13:27:43.797 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
13:27:43.799 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
13:27:43.800 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/79/(pocket-book.usage-practices_generate-data 5)
...
## OUT
```
13:27:43.801 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
