...
## OUT
```
21:50:21.111 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.114 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.116 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
21:50:21.117 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/1c/(pocket-book.usage-practices_transform 10)
...
## OUT
```
21:50:21.118 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/1c/(pocket-book.usage-practices_transform 10) existed= true
...
## OUT
```
21:50:21.119 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
21:50:21.119 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/db/(pocket-book.usage-practices_transform 1)
...
## OUT
```
21:50:21.120 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
21:50:21.120 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e4/(pocket-book.usage-practices_transform 2)
...
## OUT
```
21:50:21.121 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
21:50:21.122 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.124 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
21:50:21.124 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/58/(pocket-book.usage-practices_process-data {:data [1 2 3], :version 1})
...
## OUT
```
21:50:21.126 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
21:50:21.126 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/64/(pocket-book.usage-practices_process-data {:data [1 2 3], :version 2})
...
## OUT
```
21:50:21.128 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.130 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
21:50:21.131 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/4a/(pocket-book.usage-practices_tracked-fn 5)
...
## OUT
```
21:50:21.133 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.134 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
21:50:21.134 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/db/(pocket-book.usage-practices_transform 1)
...
## OUT
```
21:50:21.135 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
21:50:21.135 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e4/(pocket-book.usage-practices_transform 2)
...
## OUT
```
21:50:21.136 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
21:50:21.136 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e8/(pocket-book.usage-practices_tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-08T19:50:21.134428565Z"}
...
[{:path
 ...
 {:path
  ...
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-08T19:50:21.135454287Z"}
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-08T19:50:21.136477559Z"}]
...
## OUT
```
21:50:21.143 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.146 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
21:50:21.146 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/d8/(pocket-book.usage-practices_transform 99)
...
## OUT
```
21:50:21.148 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.150 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
21:50:21.151 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/6d/6d7a9c06574c78354a8235a2e77b6ed27348e404
...
## OUT
```
21:50:21.155 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
21:50:21.156 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
21:50:21.157 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/79/(pocket-book.usage-practices_generate-data 5)
...
## OUT
```
21:50:21.158 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
