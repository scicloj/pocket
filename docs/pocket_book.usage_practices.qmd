...
## OUT
```
18:40:48.073 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.074 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.075 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
18:40:48.076 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10)
...
## OUT
```
18:40:48.076 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10) existed= true
...
## OUT
```
18:40:48.077 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
18:40:48.077 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
```
18:40:48.077 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
18:40:48.078 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
18:40:48.078 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
18:40:48.079 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.080 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
18:40:48.080 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/ff/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 1})
...
## OUT
```
18:40:48.081 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
18:40:48.081 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6a/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 2})
...
## OUT
```
18:40:48.082 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.083 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
18:40:48.083 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/a5/(pocket-book.usage-practices⁄tracked-fn 5)
...
## OUT
```
18:40:48.085 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.085 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
18:40:48.085 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
18:40:48.086 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
18:40:48.086 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
18:40:48.086 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
18:40:48.086 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/64/(pocket-book.usage-practices⁄tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-06T16:40:48.085670902Z"}
...
[{:path
 ...
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-06T16:40:48.086783810Z"}
 {:path
  "/tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)",
  :id "(pocket-book.usage-practices/transform 2)",
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-06T16:40:48.086251963Z"}]
...
## OUT
```
18:40:48.090 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.091 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
18:40:48.092 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6d/(pocket-book.usage-practices⁄transform 99)
...
## OUT
```
18:40:48.093 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.093 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
18:40:48.094 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/66/66ca82f71c1e7e5a1fcebd04da5cff4cf0e04366
...
## OUT
```
18:40:48.096 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
18:40:48.096 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
18:40:48.097 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/70/(pocket-book.usage-practices⁄generate-data 5)
...
## OUT
```
18:40:48.097 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
