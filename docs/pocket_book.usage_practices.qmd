...
## OUT
```
15:54:50.521 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.523 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.524 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:54:50.524 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10)
...
## OUT
```
15:54:50.525 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10) existed= true
...
## OUT
```
15:54:50.525 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:54:50.526 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
15:54:50.526 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:54:50.526 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
15:54:50.527 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
15:54:50.527 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.529 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
15:54:50.529 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/ff/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 1})
...
## OUT
```
15:54:50.530 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
15:54:50.530 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6a/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 2})
...
## OUT
```
15:54:50.531 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.532 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
15:54:50.533 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/a5/(pocket-book.usage-practices⁄tracked-fn 5)
...
## OUT
```
15:54:50.534 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.534 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:54:50.535 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
15:54:50.535 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:54:50.535 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
15:54:50.536 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
15:54:50.536 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/64/(pocket-book.usage-practices⁄tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-06T13:54:50.534936560Z"}
...
[{:path
 ...
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-06T13:54:50.536104933Z"}
 {:path
  "/tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)",
  :id "(pocket-book.usage-practices/transform 2)",
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-06T13:54:50.535543255Z"}]
...
## OUT
```
15:54:50.540 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.541 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:54:50.541 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6d/(pocket-book.usage-practices⁄transform 99)
...
## OUT
```
15:54:50.542 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.543 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
15:54:50.543 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/66/66ca82f71c1e7e5a1fcebd04da5cff4cf0e04366
...
## OUT
```
15:54:50.545 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:54:50.546 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
15:54:50.546 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/70/(pocket-book.usage-practices⁄generate-data 5)
...
## OUT
```
15:54:50.547 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
