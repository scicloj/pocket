...
## OUT
```
16:50:41.367 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.369 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.369 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
16:50:41.370 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10)
...
## OUT
```
16:50:41.371 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10) existed= true
...
## OUT
```
16:50:41.371 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
16:50:41.371 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
16:50:41.372 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
16:50:41.372 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
16:50:41.373 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
16:50:41.373 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.375 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
16:50:41.375 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/ff/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 1})
...
## OUT
```
16:50:41.376 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
16:50:41.376 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6a/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 2})
...
## OUT
```
16:50:41.377 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.378 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.379 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
16:50:41.379 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/a5/(pocket-book.usage-practices⁄tracked-fn 5)
...
## OUT
```
16:50:41.381 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.382 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
16:50:41.382 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
```
16:50:41.382 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
16:50:41.383 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
16:50:41.383 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
16:50:41.383 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/64/(pocket-book.usage-practices⁄tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-06T14:50:41.382072828Z"}
...
[{:path
 ...
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-06T14:50:41.383521404Z"}
 {:path
  "/tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)",
  :id "(pocket-book.usage-practices/transform 2)",
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-06T14:50:41.382862773Z"}]
...
## OUT
```
16:50:41.388 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.389 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
16:50:41.389 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6d/(pocket-book.usage-practices⁄transform 99)
...
## OUT
```
16:50:41.391 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.391 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
16:50:41.392 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/66/66ca82f71c1e7e5a1fcebd04da5cff4cf0e04366
...
## OUT
```
16:50:41.395 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
16:50:41.396 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
16:50:41.396 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/70/(pocket-book.usage-practices⁄generate-data 5)
...
## OUT
```
16:50:41.397 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
