...
## OUT
```
15:38:40.751 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.753 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.754 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:38:40.754 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10)
...
## OUT
```
15:38:40.755 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10) existed= true
...
```clojure
{:path
 "/tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10)",
 :existed true}
...
## OUT
```
15:38:40.756 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:38:40.756 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
15:38:40.757 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:38:40.757 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
15:38:40.757 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
{:fn-name "pocket-book.usage-practices/transform",
 :count 2,
 :paths
 ["/tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)"
  "/tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)"]}
...
## OUT
```
15:38:40.758 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.759 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
15:38:40.759 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/ff/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 1})
...
## OUT
```
15:38:40.760 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
15:38:40.761 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6a/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 2})
...
## OUT
```
15:38:40.761 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.762 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.763 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
15:38:40.763 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/a5/(pocket-book.usage-practices⁄tracked-fn 5)
...
## OUT
```
15:38:40.765 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.765 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:38:40.765 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
15:38:40.766 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:38:40.766 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
15:38:40.766 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
15:38:40.767 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/64/(pocket-book.usage-practices⁄tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-06T13:38:40.765765306Z"}
...
[{:path
  ...
  :created-at "2026-02-06T13:38:40.765765306Z"}
 {:path
  "/tmp/pocket-dev-practices/.cache/64/(pocket-book.usage-practices⁄tracked-fn 3)",
  :id "(pocket-book.usage-practices/tracked-fn 3)",
  :fn-name "pocket-book.usage-practices/tracked-fn",
  :args-str "[3]",
  :created-at "2026-02-06T13:38:40.766931399Z"}
 {:path
  "/tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)",
  :id "(pocket-book.usage-practices/transform 2)",
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-06T13:38:40.766380191Z"}]
...
## OUT
```
15:38:40.771 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.772 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
15:38:40.772 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6d/(pocket-book.usage-practices⁄transform 99)
...
## OUT
```
15:38:40.774 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.775 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
15:38:40.775 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/66/66ca82f71c1e7e5a1fcebd04da5cff4cf0e04366
...
.cache
└── 66
    └── 66ca82f71c1e7e5a1fcebd04da5cff4cf0e04366
        ├── meta.edn
        └── value.nippy
...
## OUT
```
15:38:40.777 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
15:38:40.778 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
15:38:40.778 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/70/(pocket-book.usage-practices⁄generate-data 5)
...
## OUT
```
15:38:40.779 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
