...
## OUT
```
22:14:22.094 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.097 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.098 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
22:14:22.099 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/1c/(pocket-book.usage-practices_transform 10)
...
## OUT
```
22:14:22.100 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/1c/(pocket-book.usage-practices_transform 10) existed= true
...
## OUT
```
22:14:22.101 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
22:14:22.101 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/db/(pocket-book.usage-practices_transform 1)
...
## OUT
```
22:14:22.102 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
22:14:22.102 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e4/(pocket-book.usage-practices_transform 2)
...
## OUT
```
22:14:22.103 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
22:14:22.104 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.106 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
22:14:22.107 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/58/(pocket-book.usage-practices_process-data {:data [1 2 3], :version 1})
...
## OUT
```
22:14:22.109 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
22:14:22.109 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/64/(pocket-book.usage-practices_process-data {:data [1 2 3], :version 2})
...
## OUT
```
22:14:22.110 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.111 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.113 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
22:14:22.114 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/4a/(pocket-book.usage-practices_tracked-fn 5)
...
## OUT
```
22:14:22.116 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.117 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
22:14:22.117 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/db/(pocket-book.usage-practices_transform 1)
...
## OUT
```
22:14:22.118 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
22:14:22.118 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e4/(pocket-book.usage-practices_transform 2)
...
## OUT
```
22:14:22.119 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
22:14:22.119 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/e8/(pocket-book.usage-practices_tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-08T20:14:22.117303937Z"}
...
[{:path
 ...
 {:path
  ...
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-08T20:14:22.118343220Z"}
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-08T20:14:22.119249126Z"}]
...
## OUT
```
22:14:22.126 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.129 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
22:14:22.129 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/d8/(pocket-book.usage-practices_transform 99)
...
## OUT
```
22:14:22.131 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.132 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
22:14:22.133 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/6d/6d7a9c06574c78354a8235a2e77b6ed27348e404
...
## OUT
```
22:14:22.137 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
22:14:22.138 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
22:14:22.139 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/79/(pocket-book.usage-practices_generate-data 5)
...
## OUT
```
22:14:22.141 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
