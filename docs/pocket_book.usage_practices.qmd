...
## OUT
```
14:17:06.662 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.666 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.667 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
14:17:06.668 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10)
...
## OUT
```
14:17:06.670 INFO scicloj.pocket.impl.cache - Invalidated: /tmp/pocket-dev-practices/.cache/89/(pocket-book.usage-practices⁄transform 10) existed= true
...
## OUT
```
14:17:06.671 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
14:17:06.672 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
14:17:06.672 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
14:17:06.673 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
14:17:06.674 INFO scicloj.pocket.impl.cache - Invalidated 2 entries for pocket-book.usage-practices/transform
...
## OUT
```
14:17:06.675 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.677 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
14:17:06.677 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/ff/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 1})
...
## OUT
```
14:17:06.679 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-data
14:17:06.679 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6a/(pocket-book.usage-practices⁄process-data {:data [1 2 3], :version 2})
...
## OUT
```
14:17:06.681 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.684 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
14:17:06.684 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/a5/(pocket-book.usage-practices⁄tracked-fn 5)
...
## OUT
```
14:17:06.687 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.688 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
14:17:06.688 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/b7/(pocket-book.usage-practices⁄transform 1)
...
## OUT
```
14:17:06.689 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
14:17:06.689 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)
...
## OUT
```
14:17:06.690 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/tracked-fn
14:17:06.691 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/64/(pocket-book.usage-practices⁄tracked-fn 3)
...
{:id "(pocket-book.usage-practices/transform 1)",
 :fn-name "pocket-book.usage-practices/transform",
 :args-str "[1]",
 :created-at "2026-02-06T12:17:06.688394999Z"}
...
[{:path
 ...
 {:path
  ...
  :args-str "[3]",
  :created-at "2026-02-06T12:17:06.690673042Z"}
 {:path
  "/tmp/pocket-dev-practices/.cache/8a/(pocket-book.usage-practices⁄transform 2)",
  :id "(pocket-book.usage-practices/transform 2)",
  :fn-name "pocket-book.usage-practices/transform",
  :args-str "[2]",
  :created-at "2026-02-06T12:17:06.689597909Z"}]
...
## OUT
```
14:17:06.698 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.700 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/transform
14:17:06.701 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/6d/(pocket-book.usage-practices⁄transform 99)
...
## OUT
```
14:17:06.703 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.704 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/process-long-text
14:17:06.705 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/66/66ca82f71c1e7e5a1fcebd04da5cff4cf0e04366
...
## OUT
```
14:17:06.709 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
...
## OUT
```
14:17:06.710 INFO scicloj.pocket.impl.cache - Cache miss, computing: pocket-book.usage-practices/generate-data
14:17:06.711 DEBUG scicloj.pocket.impl.cache - Cache write: /tmp/pocket-dev-practices/.cache/70/(pocket-book.usage-practices⁄generate-data 5)
...
## OUT
```
14:17:06.712 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-dev-practices
