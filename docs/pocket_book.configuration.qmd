...
## OUT
```
14:17:04.702 INFO scicloj.pocket - Cache dir set to: /tmp/pocket-demo-config
...
## OUT
```
14:17:04.703 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-config
...
## OUT
```
14:17:04.706 INFO scicloj.pocket - Mem-cache options set: {:policy :fifo, :threshold 100}
14:17:04.706 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :fifo, :threshold 100}
...
## OUT
```
14:17:04.707 INFO scicloj.pocket - Mem-cache options set: {:policy :ttl, :ttl 60000}
14:17:04.708 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :ttl, :ttl 60000}
...
## OUT
```
14:17:04.708 INFO scicloj.pocket - Mem-cache options set: {:policy :lru, :threshold 256}
14:17:04.708 INFO scicloj.pocket.impl.cache - Mem-cache reconfigured: {:policy :lru, :threshold 256}
...
## OUT
```
14:17:04.709 INFO scicloj.pocket - Storage policy set to: :mem
...
## OUT
```
14:17:04.711 INFO scicloj.pocket - Storage policy set to: nil
...
## OUT
```
14:17:04.713 INFO scicloj.pocket - Filename length limit set to: 80
...
## OUT
```
14:17:04.714 INFO scicloj.pocket - Filename length limit set to: nil
...
## OUT
```
14:17:04.717 INFO scicloj.pocket - Cache cleanup: /tmp/pocket-demo-config
